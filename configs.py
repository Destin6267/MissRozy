...
class Config(object):
	API_ID = int(os.environ.get("API_ID", 27871446))
	API_HASH = os.environ.get("API_HASH", "692aeb1a54e3a5593357de6fbf13a665")
	BOT_TOKEN = os.environ.get("BOT_TOKEN","6936030002:AAGvmM-hejhZYWa2cIdD4Zc80Fv4YUFxLO4")
	BOT_USERNAME = os.environ.get("BOT_USERNAME" , "Yin_Yang_Anime_Bot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", -1002075850323))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "5047508930"))
	...
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002075850323")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1002075850323")
	...
	LAZY_PIC = os.environ.get("LAZY_PIC","https://t.me/+X3Sny3qhwr5jNDM1")
